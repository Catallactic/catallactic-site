    ...
    <section className={styles.services}>
      <div className="container">
				...
				<div className="text-center pb-1 mb-4">
					<div className="h1 fw-bold color-theme-reverse2">Digital Sound Money</div>
				...
				<div className="row margin-bottom--lg feature_eSJM">
					...
					<div className="col col--6 my-auto d-flex">
						<div className="padding-horiz--md">
							...
							<h5>We capture and expose the <b>intrinsic value</b> of the underlying commodity by binding a unit of the commodity to a unit of the Crommodity</h5>
							<h5 className="my-4">Crommodity combines the features of existing tokens aiming to become the first (crypto)currency representing Sound Money ever. The specifications have been written decades or centuries ago and we are in the time to apply this knowledge.</h5>
							<h5>Catallactic aims to build cryptocurrencies that comply with <b>Regression Theorem</b>, and therefore, that capture the intrinsic value of Commodities as underlaying asset.</h5>
