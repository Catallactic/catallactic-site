            ...
            <div className="col-md-9">
                <div className="tab-content" id="v-pills-tabContent">
									...
									<div className="tab-pane fade shadow rounded bg-white p-5" id="whytab2" role="tabpanel" aria-labelledby="v-pills-messages-tab">
										...
										<p className="font-italic text-muted mb-2">Catallactic aims to relief cryptocurrency issuers of Units of Account of the burden to define principles, acquire know-how, develop tools and design processes to issue tokens backed by the value of their underlying assets. The goal is that cryptocurrency issuers can focus on their core business. The goal, for the sake of practicality is to create an opinionated system, but maintain configurability.</p>
