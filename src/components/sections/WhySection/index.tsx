    ...
    <section className={styles.services}>
      <div className="container">
				...
				{<div className="h1 fw-bold color-theme-reverse2">Building Representative Money</div>}
					<p className="h3 color-theme-reverse1 mt-5 lh-base">An Open Source Framework to build <b>Decentralization in Value</b>. A step into <b>Price System</b> discovery for <b>Private Currency Competition</b>.</p>
				</div>
