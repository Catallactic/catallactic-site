            ...
            <div className="col-md-9">
                <div className="tab-content" id="v-pills-tabContent">
									...
									<div className="tab-pane fade shadow rounded bg-white p-5" id="whytab1" role="tabpanel" aria-labelledby="v-pills-competition-tab">
										...
										<hr/>
										<p className="font-italic text-muted mb-2">Catallactic aims to build cryptocurrencies that comply with <p>Regression Theorem</p>, and therefore, that capture the intrinsic value of Commodities as underlaying asset. This is why the currencies are called as <p>CryptoCommodities</p>.</p>
										<p className="font-italic text-muted mb-2">We <p>capture and expose the intrinsic value</p> of the underlying commodity by binding a unit of the commodity to a unit of the CryptoCommodity. This binding is enforced by the smart contact processing and users interaction.</p>
										<p className="font-italic text-muted mb-2">Different Commodities, issuers and scopes will have different features, so there is a degree of <p>customization</p> for the dimensions of every CryptoCommodity.</p>
									</div>
									...
									<div className="tab-pane fade shadow rounded bg-white p-5" id="whytab2" role="tabpanel" aria-labelledby="v-pills-backed-tab">
										...
										<p className="font-italic text-muted mb-2"><b>Catallactic advocates for a <p>built-in price formation</p> as a basis to deliver true <p>value decentralization</p>. Stablecoins are centralized because they are pegged to a fiat price formed in international markets</b>.</p>
									</div>
									...
									<div className="tab-pane fade shadow rounded bg-white p-5" id="whytab3" role="tabpanel" aria-labelledby="v-pills-backed-tab">
										...
										<p className="font-italic text-muted mb-2">We think there is not yet any network which is good enough and the overall status of the industry is in beta status and not yet ready for massification. As a consequence <p>we do not adhere to specific chains</p>. Instead, we build for any chains which can process transactionS on top of the <p>EVM</p>, as the more used standard for smart contracts implementation. We consider in future to adapt to other virtual machines and languages.</p>
										<p className="font-italic text-muted mb-2">Catallactic has <p>preference for PoW chains</p>. <p>EVM-enabled Bitcoin L2s</p> able being explored as ideal hosts for Catallactic smart contracts.</p>
										...
										<p className="font-italic text-muted mb-2">Finally, Catallactic is thought with <p>interoperability</p> principles in mind, allowing distribution of the liquidity across different chains, as defined by the currency issuer.</p>
									</div>
									...
									<div className="tab-pane fade shadow rounded bg-white p-5" id="whytab4" role="tabpanel" aria-labelledby="v-pills-profile-tab">
										...
										<p className="font-italic text-muted mb-2">We deliver a <p>Tokenization Platform</p> which allows adopters to issue and manage their CryptoCommodity without the technical burden.</p>
									...
									<div className="tab-pane fade shadow rounded bg-white p-5" id="whytab5" role="tabpanel" aria-labelledby="v-pills-local-tab">
										...
										<hr/>
										<p className="font-italic text-muted mb-2">Different communities have different monetary requirements and commodities availability. To enable this fine tuning of the monetary availability, we think CryptoCommodities should be issued and applicable at <p>local scope by local actors</p>. This provides a valuable tool for communities driven entrepreneurship.</p>
										<p className="font-italic text-muted mb-2">A <p>CryptoCommodity algebra</p> allows technical support for real world use cases as merges and acquisitions or CryptoCommodity splits.</p>
										<p className="font-italic text-muted mb-2">Single currencies as Bitcoin represent a single point of failure and a evident target for scammers and censonship. To deliver censorship resistance and suitAble price formation, CryptoCommodities are thought to be <p>issued by multiple actors and in full competition</p>, relying on the market the price formation task.</p>
									</div>
