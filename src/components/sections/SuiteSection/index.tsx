    ...
    <section className={styles.services}>
      <div className="container">
				...
				<div className="text-center">
					...
					<p className="h3 color-theme-reverse1 m-5 lh-base">Catallactic Suite enables any commodities producer to issue and configure a CryptoCommodity with supply split between any EVM compatible networks of his choice.</p>
				</div>
