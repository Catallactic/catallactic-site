      ...
      <div className="container">
				...
				<div className="row margin-bottom--lg feature_eSJM">
					...
					<div className="col col--6">
						...
						<div className="padding-horiz--md margin-top--lg shadow">
							<h3>VCs</h3>
							<p className="text--left">Some criteria: invest in no-fiat-tokenization, tokenized investor, disruptive, contrarian, challenge status quo, emerging market, consumer oriented, massification, no-only gaming/AI/metaverse BS</p>
