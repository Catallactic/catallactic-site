				...
				<div className="row margin-vert--xl feature_eSJM">
					...
					<div className="col col--6 my-auto d-flex">
						<div className="text--center padding-horiz--md">
							...
							<p>GasClick offers a <a href="https://gasclick.net/whitepaper_9investors.html" target='_blank'>500x bonus</a> in first round if the token is able to capture price. </p>
