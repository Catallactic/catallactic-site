...
export default function DoughnutFundingAllocationChart() {
  return (
    <>
				...
				<div className="chart-panel">
					<Doughnut
						data={{
							...
							datasets: [{
									backgroundColor: [COLORS.SUPPLY_GREY, COLORS.SUPPLY_GREY, COLORS.SUPPLY_HOLDERS, COLORS.SUPPLY_HOLDERS, COLORS.SUPPLY_HOLDERS, COLORS.SUPPLY_GREY, COLORS.SUPPLY_GREY, COLORS.SUPPLY_GREY],
									data: [9, 1, 2, 3, 5, 4, 5, 71],
									order: [11, 12, 2, 3, 4, 6, 7, 9],
									index: 0
								}, {
									backgroundColor: [COLORS.SUPPLY_GREY, COLORS.SUPPLY_HOLDERS, COLORS.SUPPLY_GREY, COLORS.SUPPLY_GREY],
									data: [10, 10, 9, 71],
									order: [1, 10, 5, 8],
									index: 1
							}]
